        ...
        <div class="content">
            <div class="row">
                ...
                <strong class="courier">Registration</strong>
                    ...
                    <div class="col-md-6 text-right courier text-muted"><em>
                ...
                <div class="row">
                        ...
                        <div class="col-md-6 text-right"> <h4 class="courier">
                            {{ number_format($prices['sprice'] + $prices['tprice'] + $prices['iprice']) }}
                        </h4> </div>
                </div>

            <form method="POST" action="{{url('patient/transactions')}}" >
            <div id="paymentArea" class="form-group col-lg-8 paymentArea"></div>
